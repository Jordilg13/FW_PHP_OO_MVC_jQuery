							...
							<div class="col-lg-12">
								...
								<form id="register-form" role="form" style="display: none;">
									...
									<div class="form-group">
										...
										<span id="reg_pass1"></span>
									</div>
									
									<div class="form-group">
										<input type="password" name="confirm-password" id="confirm-password_reg" tabindex="2" class="form-control" placeholder="Confirm Password">
										<span id="reg_pass2"></span>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
